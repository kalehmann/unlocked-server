...
#[AsCommand(
    name: 'unlocked:request:deny',
    description: 'Deny a request of the unlocked server.',
    hidden: false,
)]
class DenyRequestCommand extends Command
{
    ...
    protected function execute(
        ...
        $this->requestService->denyRequest($request);

        $io->success('Denied request "' . $request->getId() . '"');
